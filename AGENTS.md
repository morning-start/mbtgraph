...
description: MoonBit 图算法库 Agent 协作配置（v3.2 新增 I/O 模块：DOT + JSON + 图统计）
tags: [moonbit, graph-algorithms, trait-based, storage-patterns, network-flow, p5-complete, social-network-analysis, io-module, doc-system-v3, roadmap-v2]
---
...
| **当前任务清单 (v0.11.0)** | [TODO.md](docs/TODO.md) ✅ |
| **本文档 (Agent 规范)** | 👈 **你在这里** |
...
│   │
│   │  ═════════════════════════════════════════════════
│   │  ✅ 已完成模块 (v0.10.0, 15 子模块, ~588 tests)
│   │  ═════════════════════════════════════════════════
│   │
