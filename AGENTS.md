...
**当前版本**: v0.1.1 | **测试**: 940 | **API**: ✅ 冻结

## 📖 快速入口

| 想了解什么？ | 去哪里？ |
|-------------|---------|
| **项目愿景与意义** | [文档站点 → 项目愿景](https://morning-start.github.io/mbtgraph/about/vision/) |
| **架构设计与技术细节** | [文档站点 → 架构总览](https://morning-start.github.io/mbtgraph/core-concepts/architecture/) |
| **版本规划与路线图** | [文档站点 → 路线图](https://morning-start.github.io/mbtgraph/about/roadmap/) |
| **当前任务清单** | [文档站点 → 任务进度](https://morning-start.github.io/mbtgraph/about/todo/) |
| **本文档 (Agent 规范)** | 👈 **你在这里** |
...
**当前进度**: 详见 [文档站点 → 任务进度](https://morning-start.github.io/mbtgraph/about/todo/) | 完整统计: [CHANGELOG.md](CHANGELOG.md) | 算法全景: [文档站点 → 算法目录](https://morning-start.github.io/mbtgraph/algorithms/catalog/)
...
**详细设计**: [文档站点 → 架构总览](https://morning-start.github.io/mbtgraph/core-concepts/architecture/)
...
| 文档 | 路径 | 用途 |
|------|------|------|
| **项目愿景** | [文档站点 → 项目愿景](https://morning-start.github.io/mbtgraph/about/vision/) | 为什么做这个项目？意义与目标 |
| **架构总览** | [文档站点 → 架构总览](https://morning-start.github.io/mbtgraph/core-concepts/architecture/) | 怎么设计的？当前+未来架构 |
| **路线图** | [文档站点 → 路线图](https://morning-start.github.io/mbtgraph/about/roadmap/) | 版本规划与时间线 |
| **任务清单** | [文档站点 → 任务进度](https://morning-start.github.io/mbtgraph/about/todo/) | 当前版本任务分解 |
| **算法目录** | [文档站点 → 算法目录](https://morning-start.github.io/mbtgraph/algorithms/catalog/) | 图算法全景分类与实现状态 |
| **API Reference** | [文档站点 → API](https://morning-start.github.io/mbtgraph/api/core/) | API 参考文档索引（23 个模块） |
| **使用指南** | [文档站点 → 指南](https://morning-start.github.io/mbtgraph/guides/algorithm-guide/) | 使用指南索引（入门/算法/存储/性能/FAQ） |
| **更新规范** | `docs/UPDATE_GUIDE.md` | Agent 文档自动化更新规则 |
| **Trait设计** | [文档站点 → Trait设计](https://morning-start.github.io/mbtgraph/reference/design/graph-trait-architecture/) | 6层Trait详细设计 |
| **流网络设计** | [文档站点 → 流网络设计](https://morning-start.github.io/mbtgraph/reference/design/flow-network/) | 独立类型模式与6种算法 |
| **社区检测设计** | [文档站点 → 社区检测设计](https://morning-start.github.io/mbtgraph/reference/design/community-detection/) | 模块度优化与4种算法 |
| **图匹配设计** | [文档站点 → 匹配设计](https://morning-start.github.io/mbtgraph/reference/design/matching/) | 4种匹配算法设计决策 |
| **I/O模块设计** | [文档站点 → I/O设计](https://morning-start.github.io/mbtgraph/reference/design/io-module/) | DOT/JSON序列化与统计 |
| **调度分析** | [文档站点 → 调度分析](https://morning-start.github.io/mbtgraph/reference/dispatch-analysis/) | Trait动态调度分析 |
| **存储调研** | [文档站点 → 存储调研](https://morning-start.github.io/mbtgraph/reference/graph-storage-survey/) | 8种存储选型依据 |
| **竞品汇总** | [文档站点 → 竞品调研](https://morning-start.github.io/mbtgraph/reference/library-survey/) | 主流图库对比表 |
| **测试策略** | [文档站点 → 测试规范](https://morning-start.github.io/mbtgraph/contributing/testing/) | 双轨测试方法论 |
...
- 算法复杂度详情 -> [文档站点 → 算法目录](https://morning-start.github.io/mbtgraph/algorithms/catalog/)
- Sprint 任务计划 -> [文档站点 → 任务进度](https://morning-start.github.io/mbtgraph/about/todo/)
- 详细设计文档 -> [文档站点 → 参考/设计](https://morning-start.github.io/mbtgraph/reference/design/graph-trait-architecture/)
- 开发效率基准 -> 不需要持久化
