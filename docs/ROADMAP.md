...
> **最后更新**: 2026-05-26 | **当前版本**: v0.11.0 | **状态**: 🎉 数据交换与可视化完成，进入 v0.12.0 经典算法增强
...
| **算法总数** | 38+ | 含社交网络分析 (PageRank/中心性/社区) |
| **测试用例** | 630 | 全通过 ✅ |
| **代码行数** | ~10000+ | 含测试和文档 |
| **Git Tags** | 6 | v0.5.0 → v0.10.0 → v0.11.0
...
1. **[P0]** 开始 v0.12.0 经典算法增强（A* 启发式搜索）
2. **[P0]** 更新 TODO.md 规划 v0.12.0 详细任务分解
3. **[P1]** 调研 Johnson 全源最短路径算法适配 MoonBit
4. **[P1]** 准备最小费用最大流实现方案
...
- [ ] **v0.12.0 算法优先级**: A*/Johnson/费用流/HK/Edmonds/双向BFS
...
| 指标 | 当前值 (v0.11.0) | 目标值 (v1.0.0) | 衡量方式 |
|------|:---------------:|:---------------:|---------|
| **测试总数** | 630 | **≥ 773** | `moon test` |
