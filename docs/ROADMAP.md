...
> **最后更新**: 2026-05-28 | **当前版本**: v0.13.0 | **状态**: 🚀 接口重构 + P0/P1 算法补齐已发布
...
| **算法总数** | 49+ | 含 A*/双向 BFS/Hopcroft-Karp/费用流/Edmonds 匹配 |
| **测试用例** | 736 | 全通过 ✅ |
| **代码行数** | ~10500+ | 含测试和文档 |
| **Git Tags** | 8 | v0.5.0 → v0.11.0 → v0.12.0 → v0.13.0
...
| **v0.13.0** | 🛠️ 接口重构 + P0/P1 算法补齐 | — | — | **736** | ✅ 已完成 (2026-05-28) |
