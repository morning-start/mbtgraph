...
> **最后更新**: 2026-05-29 | **当前版本**: v0.15.0 🧩 经典算法扩充 ✅
> **下次评审**: 2026-06-05（每周五）
...
- [x] 更新 `lib/algo/matching/README.md` — 添加 KM/Hopcroft-Karp/Edmonds 算法 (21→56 tests)
- [x] 创建 `lib/algo/README.md` — 算法模块总索引 (19 模块, ~65 算法, 651 测试)
...
*维护者: @morning-start | 最后更新: 2026-05-29 | 目标: v0.16.0 (API 冻结候选)*
