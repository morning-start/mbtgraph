...
> **最后更新**: 2026-06-12 | **当前版本**: v0.16.0 🔧 API 冻结候选 ✅
> **下次评审**: 2026-06-19（每周五）
> **下个版本**: v1.0.0 🎉 正式发布
> **当前进度**: v0.16.0 冻结完成，待 rc.1 发布
...
> **时间范围**: 2026-05-29
> **最终测试数**: 922 (无回归)
> **核心产出**: 11 个模块, ~41 个新算法/函数, 182 新测试
>
> | 波次 | 任务 | 算法数 | 测试数 | 状态 |
> |:----:|------|:-----:|:-----:|:----:|
> | 1 | Leiden + 谱聚类 | 2 | 20 | ✅ |
...
> **目标**: 冻结所有公共 API 为 v1.0.0 预备, 覆盖 v0.15.0 遗留的 P3 任务
>
> | 优先级 | 任务 | 说明 |
> |:-----:|------|------|
> | 🟡 P1 | API 审查与冻结 | 检查所有 pub fn, 统一命名, 标记 deprecated |
> | 🟡 P1 | 文档补全 | 确保所有模块有 README.md |
> | 🟢 P2 | 容量缩放最大流 | TASK-3B 遗留 |
> | 🟢 P2 | 性能回归检查 | 与 v0.14.0 基线对比 |
> | 🔵 P3 | 算法目录更新 | 同步最新 ~310 条
...
- [x] **Leiden 算法**: Louvain 改进版，保证社区内连通性
- [x] **谱聚类**: 拉普拉斯特征向量 + K-Means 聚类
- 预期: ~6h（含测试）

#### TASK-1B: 链接预测套件

- [x] **共同邻居** / **Jaccard** / **Adamic-Adar** / **优先连接** / **资源分配**
- 预期: ~4h（含测试）

#### TASK-1C: 稠密子图基础

- [x] **K-Core 分解** / **K-Truss** / **三角计数** / **聚类系数**
- 预期: ~5h（含测试）
...
- [x] **Katz 中心性**: 衰减路径计数
- [x] **Harmonic 中心性**: 不连通图友好变体
- [x] **通信能力 / 集团中心性**
- 预期: ~5h

#### TASK-2B: 图统计扩展

- [x] **直径与半径** / **Wiener 指数** / **网络效率** / **三元组计数**
- 预期: ~3h
...
- [x] **Kuhn-Munkres 算法**: 二分图最大权完美匹配 O(V³)
- 预期: ~4h

#### TASK-3B: 网络流扩展

- [x] **Push-Relabel (HLPP)** / **Stoer-Wagner 最小割** / **容量缩放**
- 预期: ~8h
...
- [x] **补图/反转/交并差** / **图积(笛卡尔/张量/字典序)** / **线图/收缩/幂图**
- 预期: ~4h

#### TASK-4B: 特殊图判定

- [x] **弦图+完美消除序** / **二部图** / **正则/完全图** / **Havel-Hakimi**
- 预期: ~4h
...
- [x] API 审查与冻结: `docs/api_review_report.md` + `docs/API_SURFACE.md`
- [x] 文档补全: matching README + algo 总索引
- [x] Phase 2: 11 个简短别名（euler/cutpoints/hamiltonian/clique）
- [x] 容量缩放最大流 (`lib/algo/flow/capacity_scaling.mbt`)
- [x] 性能基线回归检查 (`benchmarks/`)
- [x] 算法目录更新 (`docs/algorithms_catalog.md`)

### v0.16.0: 版本待推进

| 优先级 | 任务 | 工作量 | 状态 |
|:------:|------|:------:|:----:|
| 🟡 P1 | 团队 Review 冻结文档 | ~2h | ⬜ |
| 🟡 P1 | 发布 v1.0.0-rc.1 | ~1h | ⬜ |
| 🟡 P1 | 收集用户反馈（2 周）| ~2h | ⬜ |
| 🟡 P1 | 正式发布 v1.0.0 | ~1h | ⬜ |
| **合计** | **4 tasks** | **~6h** | **0/4** |
...
| 指标 | v0.14.0 | v0.15.0 ✅ | 衡量方式 |
|------|:-------:|:---------:|---------|
| **测试总数** | 740 | **922** | `moon test` |
| **算法总数** | ~47 | **~65** | 新增 ~18 个 |
| **新模块** | 0 | **+7 个** | 目录结构 |
...
*维护者: @morning-start | 最后更新: 2026-06-12 | 目标: v0.16.0 (API 冻结候选)*
