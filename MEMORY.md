...
- **版本**: v0.11.0 (🎉 数据交换与可视化已发布)
- **架构**: MoonBit 包按目录组织，每个目录含 `moon.pkg` 声明依赖
- **总测试数**: **630 tests** (全通过 ✅)
- **算法模块**: **15 子模块** (P0-P5 + 社交网络分析) + **~38 算法** + **I/O 模块** (DOT/JSON/统计)
...
### 当前覆盖率 (v0.11.0 - 🎉 数据交换与可视化)

**总计**: **630 tests** (全通过 ✅) | **15 算法模块** | **~38 算法实现** | **I/O 模块**
