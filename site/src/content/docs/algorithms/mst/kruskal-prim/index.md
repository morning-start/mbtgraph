...
<div class="viz-preview-card">
  ...
  <a href="/mbtgraph/visualizations/kruskal/" target="_blank" class="viz-fullscreen-btn">全屏演示 Kruskal</a>
</div>

<div class="viz-preview-card">
  <iframe src="/mbtgraph/visualizations/prim/" width="100%" height="540" frameborder="0" style="height:540px"></iframe>
  <a href="/mbtgraph/visualizations/prim/" target="_blank" class="viz-fullscreen-btn">全屏演示 Prim</a>
</div>
